...
int GetHighPrChIdx(Heap *hp, Priority pr, HData, data); /* function that returns child node index which has high priority; this function is used to delete a node */
